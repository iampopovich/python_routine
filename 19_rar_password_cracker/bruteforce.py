...
def main():
    parser = optparse.OptionParser("usage%prog --fr <rarfile> -c <charset> -n <size> -n_min <min_size>")
    ...
    parser.add_option('--nmin', dest='minSize', type='int', help='min size of password')
